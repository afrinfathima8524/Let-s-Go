...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ProfileBloc() : super(ProfileInitial()) {
    ...
    on<ProfilePagePictureEditButtonClickedEvent>(profilePagePictureEditButtonClickedEvent);
  }
 ...
 final response = await apiService.fetchData();// get list from function
    ...
    User user = User(name:event.name, place: event.location,img: event.image); //edited user details
  ...
  FutureOr<void> profilePagePictureEditButtonClickedEvent(ProfilePagePictureEditButtonClickedEvent event, Emitter<ProfileState> emit) async {
